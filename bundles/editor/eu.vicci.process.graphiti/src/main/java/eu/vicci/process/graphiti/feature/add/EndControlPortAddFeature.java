...
public class EndControlPortAddFeature extends PictogramAddShapeFeature {

    static String SCENE_URI = "eu.vicci.process.graphiti/model/endcontrolport.pictograms";

    public EndControlPortAddFeature(IFeatureProvider fp) {

        super(fp, SCENE_URI, "endControlPort");
    }

    @Override
    public boolean canAdd(IAddContext context) {
        return ((getBusinessObjectForPictogramElement(context.getTargetContainer()) instanceof ProcessStep) &&
                 (context.getNewObject() instanceof EndControlPort) && !(context.getNewObject() instanceof EscalationPort));
    }
