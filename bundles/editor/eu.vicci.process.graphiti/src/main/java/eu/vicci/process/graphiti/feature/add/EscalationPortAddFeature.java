...
public class EscalationPortAddFeature extends PictogramAddShapeFeature {

    static String SCENE_URI = "eu.vicci.process.graphiti/model/escalationport.pictograms";

    public EscalationPortAddFeature(IFeatureProvider fp) {

        super(fp, SCENE_URI, "escalationPort");
    }

    @Override
    public boolean canAdd(IAddContext context) {
        return (getBusinessObjectForPictogramElement(context.getTargetContainer()) instanceof ProcessStep) && (context.getNewObject() instanceof EscalationPort);
    }
