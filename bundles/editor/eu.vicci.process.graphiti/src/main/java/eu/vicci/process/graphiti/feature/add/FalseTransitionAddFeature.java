...
/**
 */
public class FalseTransitionAddFeature extends AbstractAddFeature {
     ...
     */
    public FalseTransitionAddFeature(IFeatureProvider fp) {
    ...
    public boolean canAdd(IAddContext context) {
        return context instanceof IAddConnectionContext
                && context.getNewObject() instanceof FalseTransition;
    }
    ...
    public PictogramElement add(IAddContext context) {
        ...
        FalseTransition transition = (FalseTransition) context.getNewObject();
        ...
        polyline.setForeground(manageColor(IColorConstant.DARK_ORANGE));
        addArrow(connection);
    ...
    private Polygon addArrow(Connection connection) {
        ...
        polygon.setForeground(manageColor(IColorConstant.DARK_ORANGE));
        polygon.setBackground(manageColor(IColorConstant.DARK_ORANGE));
