...
public abstract class EndPortCreateFeature extends AbstractCreateFeature {
     ...
     */
    public EndPortCreateFeature(IFeatureProvider fp, String name,
            String description) {
