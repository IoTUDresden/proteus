...
/**
 */
public class FalseTransitionCreateFeature extends
     ...
     */
    public FalseTransitionCreateFeature(IFeatureProvider fp) {

        super(fp, "FalseTransition", "Create a FalseTransition");
    }
    ...
    public Connection create(ICreateConnectionContext context) {
        ...
        FalseTransition transition = SofiaFactory.eINSTANCE.createFalseTransition();
        transition.setId(EcoreUtil.generateUUID());
        transition.setName("FalseTransition");
