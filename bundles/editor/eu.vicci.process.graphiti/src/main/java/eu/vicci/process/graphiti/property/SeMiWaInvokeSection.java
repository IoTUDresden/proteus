...
public class SeMiWaInvokeSection extends PropertySectionBase{
    ...
    public void createControls(Composite parent,
        ...
        CLabel valueLabel = factory.createCLabel(composite, "Service Name:"); //$NON-NLS-1$
        data = new FormData();
        ...
        nodeText = factory.createText(composite, ""); //$NON-NLS-1$
        ...
        nodeText.addFocusListener(new StateFocusListener());
        ...
        valueLabel = factory.createCLabel(composite, "Node ID:"); //$NON-NLS-1$
        data = new FormData();
        data.left = new FormAttachment(0, 0);
        data.right = new FormAttachment(nodeText, -HSPACE);
    ...
    public void refresh() {
        ...
        if (pe != null) {
            ...
            if (bo instanceof SeMiWaInvoke) {
                String s = ((SeMiWaInvoke) bo).getServiceName();
                serviceText.setText(s == null ? "" : s);
            }
        }
    }
                            ...
                            new RecordingCommand(editingDomain) {
                                ...
                                protected void doExecute() {
                                    ...
                                    if (s != null) {
                                        ...
                                        ((SeMiWaInvoke) bo).setServiceName(s);
                                    }

                                    s = nodeText.getText();
                                    if (s != null) {
                                        if (map != null) {
                                            org.eclipse.graphiti.mm.algorithms.Text text = map.get("nodeID");
                                            if (text != null)
                                                text.setValue("nodeID: " + s);
                                        }
                                        ((SeMiWaInvoke) bo).setNodeId(s);
                                    }
