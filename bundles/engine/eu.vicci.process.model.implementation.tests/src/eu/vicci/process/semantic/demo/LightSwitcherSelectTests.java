...
public class LightSwitcherSelectTests extends ProcessExecutionTestsBase {
	private final static String PROCESS_PATH = "processes/semanticDemo/LightSwitcherSelect.diagram";
	private final static String PROCESS_ID = "_FkUAEGdVEeWAU9Vsr-chAw";
	
	private final static ProcessManagerPublic PROCESS_MANAGER = new ProcessManagerPublic();

	@Test
	public void lightSwitcherSelectTest() throws Exception {
