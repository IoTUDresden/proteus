...
public class LightSwitcherTests extends ProcessExecutionTestsBase {
	private final static String PROCESS_PATH = "processes/semanticDemo/LightSwitcher.diagram";
	private final static String PROCESS_ID = "_nbOiEGdTEeWAU9Vsr-chAw";
	
	private final static ProcessManagerPublic PROCESS_MANAGER = new ProcessManagerPublic();

	@Test
	public void lightSwitcherTest() throws Exception {
