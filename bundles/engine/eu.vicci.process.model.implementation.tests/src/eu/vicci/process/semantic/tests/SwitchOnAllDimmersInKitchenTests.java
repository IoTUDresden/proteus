...
public class SwitchOnAllDimmersInKitchenTests extends ProcessExecutionTestsBase {
	private final static String PROCESS_PATH = "processes/semantic/SwitchOnAllDimmersInKitchen.diagram";
	private final static String PROCESS_ID = "_oiqRUDlKEeWTCLjWIaJTrw";
	
	private final static ProcessManagerPublic PROCESS_MANAGER = new ProcessManagerPublic();

//	@Test(timeout = DEFAULT_TIMEOUT)
	@Test
	public void switchOnAllDimmersInKitchenTest() throws InterruptedException {
