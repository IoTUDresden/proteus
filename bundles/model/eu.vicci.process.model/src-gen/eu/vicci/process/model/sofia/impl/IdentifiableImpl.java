 ...
 * </p>
 * <ul>
 *   <li>{@link eu.vicci.process.model.sofia.impl.IdentifiableImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiableImpl extends EObjectImpl implements Identifiable {
	...
	protected EClass eStaticClass() {
		return SofiaPackage.Literals.IDENTIFIABLE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SofiaPackage.IDENTIFIABLE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SofiaPackage.IDENTIFIABLE__ID:
				return getId();
		}
