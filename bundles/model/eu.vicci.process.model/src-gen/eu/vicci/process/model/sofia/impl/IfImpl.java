 ...
 * </p>
 * <ul>
 *   <li>{@link eu.vicci.process.model.sofia.impl.IfImpl#getIfCondition <em>If Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfImpl extends AtomicStepImpl implements If {
	/**
	...
	protected EClass eStaticClass() {
		return SofiaPackage.Literals.IF;
	}
	...
	public NotificationChain basicSetIfCondition(Condition newIfCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SofiaPackage.IF__IF_CONDITION, oldIfCondition, newIfCondition);
	...
	public void setIfCondition(Condition newIfCondition) {
		if (newIfCondition != ifCondition) {
			...
			if (ifCondition != null)
				msgs = ((InternalEObject)ifCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SofiaPackage.IF__IF_CONDITION, null, msgs);
			if (newIfCondition != null)
				msgs = ((InternalEObject)newIfCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SofiaPackage.IF__IF_CONDITION, null, msgs);
			msgs = basicSetIfCondition(newIfCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SofiaPackage.IF__IF_CONDITION, newIfCondition, newIfCondition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SofiaPackage.IF__IF_CONDITION:
