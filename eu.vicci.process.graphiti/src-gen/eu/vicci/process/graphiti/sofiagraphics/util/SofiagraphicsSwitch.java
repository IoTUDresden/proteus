 ...
 * @generated
 */
public class SofiagraphicsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SofiagraphicsPackage.POINT: {
				Point point = (Point)theEObject;
				T result = casePoint(point);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.DIMENSION: {
				Dimension dimension = (Dimension)theEObject;
				T result = caseDimension(dimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.WIDGET: {
				Widget widget = (Widget)theEObject;
				T result = caseWidget(widget);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.RECTANGLE: {
			...
			case SofiagraphicsPackage.ROUNDED_RECTANGLE: {
				...
				if (result == null) result = caseWidget(roundedRectangle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.ELLIPSE: {
				Ellipse ellipse = (Ellipse)theEObject;
				T result = caseEllipse(ellipse);
				if (result == null) result = caseWidget(ellipse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.POLYLINE: {
				Polyline polyline = (Polyline)theEObject;
				T result = casePolyline(polyline);
				if (result == null) result = caseWidget(polyline);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.TEXT: {
			...
			case SofiagraphicsPackage.SCENE: {
				Scene scene = (Scene)theEObject;
				T result = caseScene(scene);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.STYLE: {
				Style style = (Style)theEObject;
				T result = caseStyle(style);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.COLOR: {
				Color color = (Color)theEObject;
				T result = caseColor(color);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SofiagraphicsPackage.GESTURE: {
